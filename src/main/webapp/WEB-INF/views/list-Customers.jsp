	...
	<div class="container">
		...
		<hr>
			<form action="/customermanagement/customers/search" class="form-inline">
				<a href="/customermanagement/customers/showFormForAdd" class="btn btn-primary btn-sm mb-3">Add Customer</a>
				<input type="search" name="f_name" placeholder="FirstName" class="form-control-sm ml-5 mr-2 mb-3">
				<input type="search" name="l_name" placeholder="LastName" class="form-control-sm mr-2 mb-3">
